...
internal class DefaultInterceptor(
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        // Used for logging request and response to identify their relationship
        ...
        try {
            ...
            // Caching https://stackoverflow.com/questions/23429046/can-retrofit-with-okhttp-use-cache-data-when-offline
